...
{
	[System.Serializable]
	public class GameObjectListReference : ListReference<GameObjectList>
	{
		[SerializeField]
		private GameObjectList _constantValue;
		[SerializeField]
		private GameObjectList _globalVariable;
		[SerializeField]
		private GameObjectListInstanced _instancedVariable;

		public override GameObjectList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (GameObjectList)_instancedVariable.GetList(IDToken);
