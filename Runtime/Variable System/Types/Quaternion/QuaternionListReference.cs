...
{
	[System.Serializable]
	public class QuaternionListReference : ListReference<QuaternionList>
	{
		[SerializeField]
		private QuaternionList _constantValue;
		[SerializeField]
		private QuaternionList _globalVariable;
		[SerializeField]
		private QuaternionListInstanced _instancedVariable;

		public override QuaternionList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (QuaternionList)_instancedVariable.GetList(IDToken);
