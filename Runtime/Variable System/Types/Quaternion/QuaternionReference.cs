...
{
	[System.Serializable]
	public class QuaternionReference : ValueReference<Quaternion>
	{
		[SerializeField]
		private QuaternionVariable _globalVariable;
		[SerializeField]
		private QuaternionVariableInstanced _instancedVariable;

		public QuaternionReference() : base()
		{
		}

		public QuaternionReference(Quaternion constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public QuaternionReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public QuaternionReference(Quaternion constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Quaternion";
