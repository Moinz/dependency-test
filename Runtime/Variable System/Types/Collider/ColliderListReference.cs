...
{
	[System.Serializable]
	public class ColliderListReference : ListReference<ColliderList>
	{
		[SerializeField]
		private ColliderList _constantValue;
		[SerializeField]
		private ColliderList _globalVariable;
		[SerializeField]
		private ColliderListInstanced _instancedVariable;

		public override ColliderList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (ColliderList)_instancedVariable.GetList(IDToken);
