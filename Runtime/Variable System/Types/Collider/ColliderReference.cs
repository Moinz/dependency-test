...
{
	[System.Serializable]
	public class ColliderReference : ValueReference<Collider>
	{
		[SerializeField]
		private ColliderVariable _globalVariable;
		[SerializeField]
		private ColliderVariableInstanced _instancedVariable;

		public ColliderReference() : base()
		{
		}

		public ColliderReference(Collider constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public ColliderReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public ColliderReference(Collider constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Collider";
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(ColliderVariable global, ColliderVariableInstanced instanced, Collider constant,
