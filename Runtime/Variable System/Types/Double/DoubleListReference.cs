...
{
	[System.Serializable]
	public class DoubleListReference : ListReference<DoubleList>
	{
		[SerializeField]
		private DoubleList _constantValue;
		[SerializeField]
		private DoubleList _globalVariable;
		[SerializeField]
		private DoubleListInstanced _instancedVariable;

		public override DoubleList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (DoubleList)_instancedVariable.GetList(IDToken);
