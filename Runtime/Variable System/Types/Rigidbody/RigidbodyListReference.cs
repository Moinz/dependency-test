...
{
	[System.Serializable]
	public class RigidbodyListReference : ListReference<RigidbodyList>
	{
		[SerializeField]
		private RigidbodyList _constantValue;
		[SerializeField]
		private RigidbodyList _globalVariable;
		[SerializeField]
		private RigidbodyListInstanced _instancedVariable;

		public override RigidbodyList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (RigidbodyList)_instancedVariable.GetList(IDToken);
