...
{
	[System.Serializable]
	public class RigidbodyReference : ValueReference<Rigidbody>
	{
		[SerializeField]
		private RigidbodyVariable _globalVariable;
		[SerializeField]
		private RigidbodyVariableInstanced _instancedVariable;

		public RigidbodyReference() : base()
		{
		}

		public RigidbodyReference(Rigidbody constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public RigidbodyReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public RigidbodyReference(Rigidbody constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Rigidbody";
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(RigidbodyVariable global, RigidbodyVariableInstanced instanced, Rigidbody constant,
