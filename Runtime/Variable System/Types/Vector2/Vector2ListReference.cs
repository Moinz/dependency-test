...
{
	[System.Serializable]
	public class Vector2ListReference : ListReference<Vector2List>
	{
		[SerializeField]
		private Vector2List _constantValue;
		[SerializeField]
		private Vector2List _globalVariable;
		[SerializeField]
		private Vector2ListInstanced _instancedVariable;

		public override Vector2List List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (Vector2List)_instancedVariable.GetList(IDToken);
