...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private Vector2Variable _globalVariable;
		[SerializeField]
		private Vector2VariableInstanced _instancedVariable;

		public Vector2Reference() : base()
		{
		}

		public Vector2Reference(Vector2 constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public Vector2Reference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public Vector2Reference(Vector2 constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Vector2";
