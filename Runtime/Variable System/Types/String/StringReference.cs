...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private StringVariable _globalVariable;
		[SerializeField]
		private StringVariableInstanced _instancedVariable;
		...
		public StringReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public StringReference(string constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant String";
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(StringVariable global, StringVariableInstanced instanced, string constant,
