...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private FloatVariable _globalVariable;
		[SerializeField]
		private FloatVariableInstanced _instancedVariable;
		...
		public FloatReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public FloatReference(float constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Float";
