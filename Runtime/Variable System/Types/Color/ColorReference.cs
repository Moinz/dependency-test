...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private ColorVariable _globalVariable;
		[SerializeField]
		private ColorVariableInstanced _instancedVariable;

		public ColorReference() : base()
		{
		}

		public ColorReference(Color constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public ColorReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public ColorReference(Color constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Color";
