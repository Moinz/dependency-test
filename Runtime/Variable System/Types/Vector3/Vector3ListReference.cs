...
{
	[System.Serializable]
	public class Vector3ListReference : ListReference<Vector3List>
	{
		[SerializeField]
		private Vector3List _constantValue;
		[SerializeField]
		private Vector3List _globalVariable;
		[SerializeField]
		private Vector3ListInstanced _instancedVariable;

		public override Vector3List List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (Vector3List)_instancedVariable.GetList(IDToken);
