...
{
	[System.Serializable]
	public class CameraReference : ValueReference<Camera>
	{
		[SerializeField]
		private CameraVariable _globalVariable;
		[SerializeField]
		private CameraVariableInstanced _instancedVariable;

		public CameraReference() : base()
		{
		}

		public CameraReference(Camera constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public CameraReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public CameraReference(Camera constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Camera";
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(CameraVariable global, CameraVariableInstanced instanced, Camera constant,
