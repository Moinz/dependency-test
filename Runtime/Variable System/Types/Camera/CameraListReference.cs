...
{
	[System.Serializable]
	public class CameraListReference : ListReference<CameraList>
	{
		[SerializeField]
		private CameraList _constantValue;
		[SerializeField]
		private CameraList _globalVariable;
		[SerializeField]
		private CameraListInstanced _instancedVariable;

		public override CameraList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (CameraList)_instancedVariable.GetList(IDToken);
