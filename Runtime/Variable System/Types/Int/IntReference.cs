...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private IntVariable _globalVariable;
		[SerializeField]
		private IntVariableInstanced _instancedVariable;
		...
		public IntReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public IntReference(int constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Int";
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(IntVariable global, IntVariableInstanced instanced, int constant,
