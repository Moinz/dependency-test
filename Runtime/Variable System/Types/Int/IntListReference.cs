...
{
	[System.Serializable]
	public class IntListReference : ListReference<IntList>
	{
		[SerializeField]
		private IntList _constantValue;
		[SerializeField]
		private IntList _globalVariable;
		[SerializeField]
		private IntListInstanced _instancedVariable;

		public override IntList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (IntList)_instancedVariable.GetList(IDToken);
