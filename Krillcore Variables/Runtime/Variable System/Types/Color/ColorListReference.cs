...
{
	[System.Serializable]
	public class ColorListReference : ListReference<ColorList>
	{
		[SerializeField]
		private ColorList _constantValue;
		[SerializeField]
		private ColorList _globalVariable;
		[SerializeField]
		private ColorListInstanced _instancedVariable;

		public override ColorList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (ColorList)_instancedVariable.GetList(IDToken);
