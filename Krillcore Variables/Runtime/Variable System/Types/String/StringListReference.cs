...
{
	[System.Serializable]
	public class StringListReference : ListReference<StringList>
	{
		[SerializeField]
		private StringList _constantValue;
		[SerializeField]
		private StringList _globalVariable;
		[SerializeField]
		private StringListInstanced _instancedVariable;

		public override StringList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (StringList)_instancedVariable.GetList(IDToken);
