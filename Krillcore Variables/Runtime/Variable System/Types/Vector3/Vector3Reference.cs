...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private Vector3Variable _globalVariable;
		[SerializeField]
		private Vector3VariableInstanced _instancedVariable;
		...
		public Vector3Reference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public Vector3Reference(Vector3 constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Vector3";
