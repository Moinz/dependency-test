...
{
	[System.Serializable]
	public class BoolListReference : ListReference<BoolList>
	{
		[SerializeField]
		private BoolList _constantValue;
		[SerializeField]
		private BoolList _globalVariable;
		[SerializeField]
		private BoolListInstanced _instancedVariable;

		public override BoolList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (BoolList)_instancedVariable.GetList(IDToken);
