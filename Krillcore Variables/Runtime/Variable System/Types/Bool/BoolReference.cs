...
namespace Torstein.VariableSystem
{
	...
	{
		[SerializeField]
		private BoolVariable _globalVariable;
		[SerializeField]
		private BoolVariableInstanced _instancedVariable;
		...
		public BoolReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public BoolReference(bool constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(BoolVariable global, BoolVariableInstanced instanced, bool constant,
