...
{
	[System.Serializable]
	public class FloatListReference : ListReference<FloatList>
	{
		[SerializeField]
		private FloatList _constantValue;
		[SerializeField]
		private FloatList _globalVariable;
		[SerializeField]
		private FloatListInstanced _instancedVariable;

		public override FloatList List
		{
			get
			{
				switch (_assignmentType)
				{
					case AssignmentType.PersonalVariable:
						return (FloatList)_instancedVariable.GetList(IDToken);
