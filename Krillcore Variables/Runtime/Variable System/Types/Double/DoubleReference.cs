...
{
	[System.Serializable]
	public class DoubleReference : ValueReference<double>
	{
		[SerializeField]
		private DoubleVariable _globalVariable;
		[SerializeField]
		private DoubleVariableInstanced _instancedVariable;

		public DoubleReference() : base()
		{
		}

		public DoubleReference(double constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public DoubleReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public DoubleReference(double constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Double";
