...
{
	[System.Serializable]
	public class TransformReference : ValueReference<Transform>
	{
		[SerializeField]
		private TransformVariable _globalVariable;
		[SerializeField]
		private TransformVariableInstanced _instancedVariable;

		public TransformReference() : base()
		{
		}

		public TransformReference(Transform constantValue) : base(constantValue)
		{
			_constantValue = constantValue;
		}

		public TransformReference(AssignmentType type) : base(type)
		{
			_assignmentType = type;
		}
	
		public TransformReference(Transform constantValue, AssignmentType type) : base(constantValue, type)
		{
			_constantValue = constantValue;
			_assignmentType = type;
		}
        ...
        public override string Name
        {
        	get
        	{
        		switch (_assignmentType)
        		{
        			case AssignmentType.Constant: return $"Constant Transform";
...
#if UNITY_EDITOR
   		public void EditorSetVariableData(TransformVariable global, TransformVariableInstanced instanced, Transform constant,
